 ...
 */
 ...
 export class PopupManager {
     ...
     private constructor() {
         ...
         console.log(' director.getScene():', director)
     }
     ...
     show(option: { name?: string, prefab?: Prefab, path?: string, priority?: number, params?: any, keep?: boolean }) {
         ...
         console.log('show:', this, this.nodes)
     ...
     private setParent() {
         ...
         this.popupNode.addChild(this.blockInputNode);
         ...
         blockInputTransform.priority = 9999;
         this.blockInputNode!.active = false;
     }
 }
